  ...
  return (
    <div>
      <h1 className="text-[80px] max-[400px]:text-[35px] font-bold font-epilogue text-center bg-clip-text bg-gradient-to-r from-[#0658c2] to-[#12be6b] text-transparent">
        Welcome to Decentralized CrowdFunding Campaign
      </h1>
      ...
      <p className="text-left text-[#c5c9c8] font-epilogue text-[17px] mx-[5%] my-4 ">
        ...
        raise funds in crypto. This is a Crowdfunding platform based on the
        famous Ethereum Network.
        <br />
        ...
        All you need is a Metamask Account and boom! you can create and donate
        to as many campaigns as you want. <br />
        <br />
